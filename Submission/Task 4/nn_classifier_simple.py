...
nn = billy_nn( architecture = [1024,200,100,10], bias = False, activation = 'RELU',  learning_rate = 0.0001)     # standard call gets you an MLP. So only 1 hidden layer.
...
batch_size = 265 #size of the mini-batch
epochs = 50 
...
num_of_batches = round(train_imgs.shape[0] / batch_size)
